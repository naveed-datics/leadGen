  ...
  try {
    ...
    const leadRows = await db
      .select({
        ...
        proposalDeliveredAt: proposals.deliveredAt,
        proposalReadAt: proposals.readAt,
          ...
          row.proposalId
            ? (() => {
                ...
                return {
                  ...
                  deliveredAt: row.proposalDeliveredAt?.toISOString() ?? null,
                  readAt: row.proposalReadAt?.toISOString() ?? null,
